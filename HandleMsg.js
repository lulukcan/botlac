...
module.exports = HandleMsg = async (aruga, message) => {
    try {
        ...
        case 'nulis':
            ...
            await aruga.sendImage(from, `${nulisp}`, '', 'Succes...*Bot LAC*', id)
            .catch(() => {
        ...
        case 'anime':
            ...
            if (args[0] == 'random' || args[0] == 'waifu' || args[0] == 'husbu' || args[0] == 'neko') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomnimex, '', 'Succes...*Bot LAC*', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang eror!', id)
                })
        ...
        case 'kpop':
            ...
            if (args[0] == 'blackpink' || args[0] == 'exo' || args[0] == 'bts') {
                ...
                .then(body => {
                    ...
                    aruga.sendFileFromUrl(from, randomkpopx, '', 'Succes...*Bot LAC*', id)
                })
                .catch(() => {
                    aruga.reply(from, 'Ada yang eror!', id)
                })
        ...
        case 'resep':
            ...
            aruga.reply(from, hasilresep + '\n\nIni kak resep makanannya.. *BOT LAC*', id)
            .catch(() => {
                aruga.reply(from, 'Ada yang eror!', id)
            })
            break
